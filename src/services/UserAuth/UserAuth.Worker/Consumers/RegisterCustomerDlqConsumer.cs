...
/// <summary>
/// Dead-Letter Queue consumer for <c>userauth.customer.register.dlq</c>.
/// Logs failed messages for investigation.
/// </summary>
public sealed class RegisterCustomerDlqConsumer : IConsumerService
{
    private const string QueueName = "userauth.customer.register.dlq";

    private readonly IConnectionFactory _connectionFactory;
    private readonly ILogger<RegisterCustomerDlqConsumer> _logger;

    private IConnection? _connection;
    private IChannel? _channel;

    public string Name => nameof(RegisterCustomerDlqConsumer);

    public RegisterCustomerDlqConsumer(
        IConnectionFactory connectionFactory,
        ILogger<RegisterCustomerDlqConsumer> logger)
    {
