...
/// <summary>
/// Catches any unhandled exception that escapes the MediatR pipeline and returns
/// a consistent 500 JSON error envelope instead of exposing stack traces.
///
/// Inspired by SERA's GlobalException middleware.
/// </summary>
